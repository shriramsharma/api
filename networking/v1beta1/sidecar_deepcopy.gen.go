...
// DeepCopyInto supports using SecurityMode within kubernetes types, where deepcopy-gen is used.
func (in *SecurityMode) DeepCopyInto(out *SecurityMode) {
	p := proto.Clone(in).(*SecurityMode)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecurityMode. Required by controller-gen.
func (in *SecurityMode) DeepCopy() *SecurityMode {
	if in == nil {
		return nil
	}
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new SecurityMode. Required by controller-gen.
func (in *SecurityMode) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using TLSSettings within kubernetes types, where deepcopy-gen is used.
func (in *TLSSettings) DeepCopyInto(out *TLSSettings) {
	p := proto.Clone(in).(*TLSSettings)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSSettings. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new TLSSettings. Required by controller-gen.
func (in *TLSSettings) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
